...
%% Moon Landing %% 
% Implementation of the Moon Landing transcription %

classdef MoonLanding < Problems.AbstractOCP
    ...
    methods 
        % Constructor 
        function [obj] = MoonLanding(myStateDim, myControlDim, myParams, myInitial, myFinal)
