...
%% LQR %% 
% Implementation of the linear Kalman finite horizon LQR transcription %

classdef LQR < Problems.AbstractOCP
    ...
    methods 
        % Constructor 
        function [obj] = LQR(myStateDim, myControlDim, myParams, myInitial, myFinal)
